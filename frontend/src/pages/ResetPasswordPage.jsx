...
import { Loader2, MessageSquare, Eye, EyeOff, Lock } from "lucide-react";
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <AuthImagePattern
        ...
        subtitle="Set a strong password to protect your account and keep your conversations private."
      />
    </div>
  );
};
